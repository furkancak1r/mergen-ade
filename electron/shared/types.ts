...
export interface IpcChannels {
  ...
  'git:fileDiff': (opts: { repoPath: string; filePath: string }) => Promise<GitFileDiff>;
  ...
  // AI CLI config
  'codex:generateTerminalConfig': (opts: { cwd: string }) => Promise<string>;
